...
export const SignUp = ({ onSwitchToSignIn }: SignUpProps) => {
  ...
  const handleGetOTP = async (e: React.FormEvent) => {
    ...
    if (!formData.name.trim() || !formData.dateOfBirth.trim() || !formData.email.trim()) {
      return;
    }
    ...
    setIsLoading(true);
          ...
          try {
        const otp = await signUp(formData.email, formData.name, formData.dateOfBirth);
    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Sign up to enjoy the features of Notes App.</p>
        </div>
        ...
        {!otpSent ? (
          <form onSubmit={handleGetOTP} className="space-y-6">
            ...
            <Button
              ...
              disabled={isLoading || !formData.name.trim() || !formData.dateOfBirth.trim() || !formData.email.trim()}
            >
          ...
          <form onSubmit={handleVerifyOTP} className="space-y-6">
            {/* User Info Display */}
            <div className="text-center p-3 bg-gray-50 rounded-lg space-y-1">
            ...
            <div className="text-center p-3 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-xs text-blue-500 mt-1">Copy this OTP to verify your signup</p>
            </div>
            ...
            <div className="relative">
              <div className="relative">
                <Input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className={`h-12 px-3 pr-10 border-2 rounded-lg bg-white focus:ring-0 focus:border-blue-500 transition-all duration-200 ${
